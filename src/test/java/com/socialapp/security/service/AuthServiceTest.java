...
class AuthServiceTest {
  ...
  // AuthProperties is injected into AuthService but never actually read by any of its methods
  // (dead dependency), so it is deliberately left unmocked here — @InjectMocks passes null for
  // it, which is fine since nothing dereferences it.
